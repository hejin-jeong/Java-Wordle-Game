...
public class Medium implements LevelSelector {

    private int roundCount; // The row which the user is working on
    private int score; // The current score
    private String answer; // The answer

    int nrows = 6; // Number of rows, i.e. the number of allowed attempts
     ...
     * @param animation
     */
    public Medium(String answer, TextField scoreField, Label solutionLabel, int cumulativeScore, Animation animation) {
        try {
