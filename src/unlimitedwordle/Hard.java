...
public class Hard implements LevelSelector {

    private int roundCount; // The row which the user is working on
    private int score; // The current score
    private String answer; // The answer

    int nrows = 5; // Number of rows, i.e. the number of allowed attempts
     ...
     * @param animation
     */
    public Hard(String answer, TextField scoreField, Label solutionLabel, int cumulativeScore, Animation animation) {
        try {
